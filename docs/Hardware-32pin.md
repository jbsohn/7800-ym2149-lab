...
Unlike the 28-pin board (ATF16V8B), this board uses an **ATF22V10** (24-pin PLD). It performs both address decoding _and_ ROM bank mapping: the YM2149's IOA0–IOA3 pins feed the PLD, which generates the ROM's upper address lines A14–A17. Every pin of the PLD is used.
...
| $4000–$7FFF     | **Switched 16KB window** — song/level data    | 16KB bank _N_, where _N_ = IOA[3:0]               |
